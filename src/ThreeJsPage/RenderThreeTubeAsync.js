...
// import LineGeometry from 'three/examples/js/lines/LineGeometry';
// import LineMaterial from 'three/examples/js/lines/LineMaterial';
//
// import LineSegmentsGeometry from 'three/examples/js/lines/LineSegmentsGeometry';
...
export default (canvas, THREE, dat) => {
  ...
  var potentialBorder = new THREE.Mesh(
  ...
  // geometry.setPositions( [0,0,1,0,1,0,0,1,1,1,1,0] );
  ...
  [
    // blueBorder, blueCube,
    greenCube, greenBorder].forEach(cube => {
    scene.add(cube)
  });
...
//       transparent: true,
//     }
//     let atmosphereMaterialOptions = Object.assign(atmosphereMaterialDefaults,
...
//     let atmosphericGlowMaterial = planetProto.glowMaterial(options.atmosphere.glow.intensity,
//       options.atmosphere.glow.fade,
//       options.atmosphere.glow.color);
//     let atmosphericGlow = new THREE.Mesh(atmosphericGlowGeometry,
...
//     let position = markerProto.latLongToVector3(options.latitude,
//       options.longitude,
//       options.radius,
//       options.height);
...
//
// // dat.gui controls
//   guiCamera.add(cameraControls,
//     'speed',
//     0,
//     0.1).step(0.001).onChange(function(value) {
...
//   });
//   guiSurface.add(surfaceControls, 'bumpScale', 0, 1).step(0.01).onChange(
//     function(value) {
...
//
//   guiAtmosphere.add(atmosphereControls,
//     'opacity',
//     0,
//     1).onChange(function(value) {
//     earth.getObjectByName('atmosphere').material.opacity = value;
//   });
//
//   guiAtmosphericGlow.add(atmosphericGlowControls, 'intensity', 0, 1).onChange(
//     function(value) {
//       earth.getObjectByName('atmosphericGlow').material.uniforms['c'].value = value;
//     });
//   guiAtmosphericGlow.add(atmosphericGlowControls, 'fade', 0, 50).onChange(
//     function(value) {
//       earth.getObjectByName('atmosphericGlow').material.uniforms['p'].value = value;
//     });
//   guiAtmosphericGlow.addColor(atmosphericGlowControls, 'color').onChange(
//     function(value) {
//       earth.getObjectByName('atmosphericGlow').material.uniforms.glowColor.value.setHex(
//         value);
//     });
//
//   return gui
